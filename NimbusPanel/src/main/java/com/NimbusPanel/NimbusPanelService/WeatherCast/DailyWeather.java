...
public class DailyWeather {
    ...
    @ManyToOne
    @JoinColumn(name = "weather_cast_id")
	...
	public DailyWeather(Long id, long dt, long sunrise, long sunset, long moonrise, long moonset, double moon_phase,
	...
	public DailyWeather(long dt, long sunrise, long sunset, long moonrise, long moonset, double moon_phase,
			Temperature temp, Temperature feels_like, int pressure, int humidity, double dew_point, double wind_speed,
			int wind_deg, double wind_gust, List<WeatherCondition> weather, int clouds, double pop, double rain,
			double uvi) {
		this.dt = dt;
	...
	public String toString() {
		return "DailyWeather [id=" + id + ", dt=" + dt + ", sunrise=" + sunrise + ", sunset=" + sunset + ", moonrise="
